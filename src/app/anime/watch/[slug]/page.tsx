            ...
            <div className="w-full flex items-center justify-center gap-2 sm:gap-8 py-2 sm:py-3 select-none flex-wrap text-xs sm:text-base">
              ...
              >
                ...
                <span>
                  ...
                  <span
                    className={isLightOn ? "text-blue-500" : "text-gray-500"}
                  >
                    {isLightOn ? "On" : "Off"}
                  </span>
                </span>
              ...
              <div className="flex items-center gap-1 sm:gap-2 text-white">
                <span>
                  Авто далі <span className="text-gray-500">Off</span>
                </span>
              </div>
              <div className="flex items-center gap-1 sm:gap-2 text-white">
                <span>
                  Автоматичний пропуск вступу{" "}
                  <span className="text-blue-500">Off</span>
                </span>
              </div>
            </div>
            <div
              className="w-full flex flex-row gap-0 mt-6 rounded-2xl overflow-hidden shadow-lg"
            ...
            >
              ...
              <div className="flex-1 bg-[#181A20] flex flex-col justify-center px-2 sm:px-6 py-2 sm:py-4">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-2 sm:mb-3">
                  ...
                  <button className="bg-blue-500 text-white rounded-xl px-3 sm:px-4 py-0.5 sm:py-1 font-medium text-xs sm:text-sm">
                    AMANOGAWA
                  </button>
                  <button className="bg-[#23262F] text-white rounded-xl px-3 sm:px-4 py-0.5 sm:py-1 font-medium text-xs sm:text-sm">
                    FutaShine
                  </button>
                  <button className="bg-[#23262F] text-white rounded-xl px-3 sm:px-4 py-0.5 sm:py-1 font-medium text-xs sm:text-sm">
                    Clan Kaizoku
